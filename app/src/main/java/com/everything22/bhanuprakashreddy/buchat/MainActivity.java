package com.everything22.bhanuprakashreddy.buchat;
...
import com.everything22.bhanuprakashreddy.buchat.ui.FriendsFragment;
import com.everything22.bhanuprakashreddy.buchat.ui.GroupFragment;
import com.everything22.bhanuprakashreddy.buchat.ui.LoginActivity;
import com.everything22.bhanuprakashreddy.buchat.ui.UserProfileFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(toolbar != null) {
            ...
            getSupportActionBar().setTitle("BU-Chat");
        }
...
//    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.about) {
            Toast.makeText(this, "BU-chat version 1.0", Toast.LENGTH_LONG).show();
            return true;
        }
